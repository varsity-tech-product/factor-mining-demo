...
PRODUCT_FACING_FILES = [
    ...
    PLUGIN / "skills" / "factor-mining-batch-test" / "SKILL.md",
    PLUGIN / "skills" / "factor-mining-batch-test-batch" / "SKILL.md",
    PLUGIN / "skills" / "factor-mining-batch-test" / "agents" / "openai.yaml",
    PLUGIN / "skills" / "factor-mining-batch-test-batch" / "agents" / "openai.yaml",
...
def main() -> None:
    ...
    require(PLUGIN / "skills" / "factor-mining-batch-test" / "SKILL.md")
    require(PLUGIN / "skills" / "factor-mining-batch-test-batch" / "SKILL.md")
    require(PLUGIN / "skills" / "factor-mining-batch-test" / "agents" / "openai.yaml")
    require(PLUGIN / "skills" / "factor-mining-batch-test-batch" / "agents" / "openai.yaml")
    ...
    require_absent(ROOT / "adapters" / "claude-code" / "factor-mining-batch-test" / "bin")
    require_absent(MCP_ROOT / "factor_mining_agent_lib" / "cli.py")

    codex_marketplace = load_json(ROOT / ".agents" / "plugins" / "marketplace.json")
    codex_entry = codex_marketplace["plugins"][0]
    assert codex_entry["name"] == "factor-mining-batch-test"
    assert codex_entry["source"] == {"source": "local", "path": "./plugins/factor-mining-batch-test"}

    claude_marketplace = load_json(ROOT / ".claude-plugin" / "marketplace.json")
    claude_entry = claude_marketplace["plugins"][0]
    assert claude_entry["name"] == "factor-mining-batch-test"
    assert claude_entry["source"] == "./plugins/factor-mining-batch-test"
