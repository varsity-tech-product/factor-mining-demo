...
def main() -> int:
    ...
    if not server_path.is_file():
        sys.stderr.write("Factor Mining Batch Test MCP launcher could not find server.py.\n")
        return 1
    ...
    try:
        ...
        message = f"Factor Mining Batch Test MCP launcher could not start the bundled server: {exc}\n"
